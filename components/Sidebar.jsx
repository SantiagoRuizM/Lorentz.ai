...
const ITEM_DEPLOY = { id: 'deploy', label: 'Despliegue L2', icon: <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M9 2v10M5 8l4 4 4-4M2 15h14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg> };
...
const NAV_PROFESOR = [
  ...
  { id: 'cursos',    label: 'Cursos',      icon: <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="3" y="2" width="12" height="14" rx="1" stroke="currentColor" strokeWidth="1.5"/><path d="M6 6h6M6 9h6M6 12h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg> },
...
const NAV_INVESTIGADOR = [
  { id: 'nexus', label: 'Nexus', icon: <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="2" r="1.5" fill="currentColor"/><circle cx="4" cy="8" r="1.5" fill="currentColor" opacity="0.7"/><circle cx="14" cy="8" r="1.5" fill="currentColor" opacity="0.7"/><circle cx="2" cy="15" r="1.5" fill="currentColor" opacity="0.5"/><circle cx="7" cy="15" r="1.5" fill="currentColor" opacity="0.5"/><circle cx="11" cy="15" r="1.5" fill="currentColor" opacity="0.5"/><circle cx="16" cy="15" r="1.5" fill="currentColor" opacity="0.5"/><path d="M9 3.5L4 6.5M9 3.5L14 6.5M4 9.5L2 13.5M4 9.5L7 13.5M14 9.5L11 13.5M14 9.5L16 13.5" stroke="currentColor" strokeWidth="1" opacity="0.5" strokeLinecap="round"/></svg> },
  { id: 'synaptrac', label: 'Synaptrac', icon: <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="3" fill="currentColor" opacity="0.9"/><circle cx="9" cy="9" r="7" stroke="currentColor" strokeWidth="1.5" opacity="0.5"/><path d="M9 2v2M9 14v2M2 9h2M14 9h2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg> },
  { id: 'graph',     label: 'Grafo Personal', icon: <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="7" y="7" width="4" height="4" fill="currentColor"/><rect x="1" y="1" width="4" height="4" fill="currentColor" opacity="0.6"/><rect x="13" y="1" width="4" height="4" fill="currentColor" opacity="0.6"/><rect x="1" y="13" width="4" height="4" fill="currentColor" opacity="0.6"/><rect x="13" y="13" width="4" height="4" fill="currentColor" opacity="0.6"/><path d="M5 3h8M3 5v8M15 5v8M5 15h8" stroke="currentColor" strokeWidth="1" opacity="0.35"/></svg> },
